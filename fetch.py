#!/usr/bin/env python3
"""
Recuperation des codes promo Helline depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/helline.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/helline.fr"
STORE_NAME = "Helline"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Helline depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-helline)"
    }
    try:
